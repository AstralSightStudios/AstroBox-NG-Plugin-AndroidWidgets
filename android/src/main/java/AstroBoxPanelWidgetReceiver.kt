...
class AstroBoxPanelWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateWidgets(
            ...
            Log.i(
                TAG,
                "update panel widgets: count=${appWidgetIds.size}, updatedAt=${snapshot.updatedAt}, connected=${snapshot.connectedDevicePanel.connected}"
            )
